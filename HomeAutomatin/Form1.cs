...
namespace HomeAutomatin
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            _recognizer.SpeechRecognized += new EventHandler<SpeechRecognizedEventArgs>(Default_SpeechRecognozed);
        ...
        private void Default_SpeechRecognozed(object sender, SpeechRecognizedEventArgs e)
        {
            int ranNum; // Generates a random number between 1 and 2 (inclusive)
